...
feature_days = [
    ...
    (constants.JD_ZD0, '子輿日 Origin (紀元)'),
    (constants.JD_ZD0 - 3, '最靠近子輿日紀元的冬至 (GCal: -3034-12-20)'),
    (constants.JD_ZD0 - 2, '子輿日紀元所在歲首'),
    ...
    (1683428.1708, '西漢元封7年10月28日 天文冬至'),  # 壬戌, GC:-104/12/20; JC:-105/12/23 [2]
    (1683430.1708, '西漢元封7年11月01日 曆書朔旦冬至甲子 (太初曆)'),  # 甲子, GC:-104/12/22; JC:-105/12/25 [2]
    # (1683489.1708, '西漢太初1年01月01日'),  # 癸亥, GC:-103/2/19; JC:-104/2/22 [2]
    (1955170.1708, '唐貞觀十四年11月01日 曆書朔旦冬至甲子 (平朔戊寅元曆)'),  # 甲子, GC:640/12/22; JC:640/12/19 [2]
    (1955169.1708, '唐貞觀十四年閏10月30日 天文冬至'),  # 癸亥, GC:640/12/21; JC:640/12/18 [2]
    (2353711.5, '華盛頓生日'),  # (JC:1731-02-11(Old Style); GC:1732-02-22)
    (1458495.5, '魯隱公三年二月己巳日日食 (BCE720-02-22)'),  # 《三千五百年曆日天象表》981頁，前720年02月22日
    (2442403.5, '西元 1974 冬至 (1974-12-22)'),
    (2443864.5, '西元 1978 冬至 (1978-12-22)'),
    (2451544.5, '西元 2000 元旦 (2000-01-01)'),
    (2459935.5, '西元 2022 冬至 (2022-12-22)'),
    (2817142.5, '西元 3000 冬至 (3000-12-22)'),
    (3912869.5, '西元 6000 冬至 (6000-12-21)'),
    (4643352.5, '西元 8000 冬至 (8000-12-19)'),
    (5008594.5, '西元 9000 冬至 (9000-12-19)'),
    (5373470.5, '西元 9999 冬至 (9999-12-18)')
]
...
if __name__ == "__main__":
    ...
    #   [ ] 思考 zd 的整數、小數位與日期關係
    #   [ ] 搞清楚[紀年轉換工具]的[公元],[英國],[儒略曆],[格里曆]等欄位資訊
